    ...
    return (
      <React.Fragment>
        ...
        <p>
          ...
          used in your app. You will see if you click on the "Change the State"
          button it will change the word inside the yellow badge from "Zero" to
          the number "1". Clicking on the "Change the State" button again
          increases the number as you click on it. You will also see that there
          is another counter below which also updates when you change the state.
          This other counter resides in a child component of this component. The
          changes made to this parent component are passed down to the child
          component.
        </p>
        <h4>
          <span
